...
'''
***********************************************
Get installed maps at COD2/4 server.
...
if numrows > 0:
    ...
    if rootServer['id'] == thisServerId:
        ...
        if type['name'] == 'cod':
            ...
            # Запуск скрипта проверки пользовательских карт от имени пользователя
            try:
            ...
            # Запуск проверки серверных карт, исключаем CoD2
            if template['name'] != 'cod2':
                mapsPaths = ['zone/english', 'zone/russian']
