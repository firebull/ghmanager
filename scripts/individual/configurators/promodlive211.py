...
configTemp = "/images/scripts/servers_configs/cod/cod4/mods/promodlive211/modserver.cfg"
config = serverPath + "/" + addonPath + "/mods/promodlive211/modserver.cfg"
pbConfig = serverPath + "/pb/pbsvuser.cfg"

# Сначала прописать админа
...
text = '''
// Закомментируйте или удалите две строки ниже, если вы отключаете или удаляете Promod LIVE
pb_sv_load stock_iwd_md5.cfg
pb_sv_load promod_iwd_md5.cfg // match-server only
'''

addInfoToConfig(pbConfig, text)
