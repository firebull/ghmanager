...
'''
Необходимо удалить старый GunGame, который не поддерживает SDKHooks:

plugins/gungame.smx
'''

try:
    if os.path.exists(sourceModPath + '/plugins/gungame.smx'):
        os.remove(sourceModPath + '/plugins/gungame.smx')
