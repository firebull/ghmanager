...
turnAmxPluginOff(serverPath + "/" + addonPath, ['plmenu', 'adminvote'])

plugin = "advanced_bans.amxx"
modules = ['engine', 'cstrike']

setPluginForAmxmodx(serverPath + "/" + addonPath, plugin, modules, 'top')

plugin = "adminvote_ab.amxx"
modules = None

setPluginForAmxmodx(serverPath + "/" + addonPath, plugin, modules)

plugin = "plmenu_ab_base.amxx"
modules = None
