...
class Map extends AppModel {
	...
	public function fileUploadErrorMessage( $error_code = null) {
	    switch ($error_code) {
	...
	public function imageIsAllowedType( $type = null ) {
	...
	public function typeToExtension($type = null) {
	...
	public function imageIsAllowedSize($image = null) {
		$height = 1280; // pixels
		$width  = 1024; // pixels
		$size   = 500000;  // bytes
	...
	public function resizeImage($image = null, $saveName = null, $path = "/img/gameMaps/") {
			$maxWidth  = 320;
			$maxHeight = 240;
