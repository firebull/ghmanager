		...
		<div style="display: inline;" class="icons">
			<ul id="icons_<?php echo $serverId;?>" class="ui-widget ui-helper-clearfix">
				<li class="ui-state-default ui-corner-all" title="Остановить сервер">
							...
							$effect = $js->get('#server_control_stop_'.$serverId)->effect('slideIn');		
				...
				<li class="ui-state-default ui-corner-all" title="Перезапустить сервер">
							...
							$effect = $js->get('#server_control_restart_'.$serverId)->effect('slideIn');		
							$event  = $js->request(array('controller'=>'servers',
				...
				<li class="ui-state-default ui-corner-all" title="Просмотр и смена паролей">
							...
							echo $html->link('<span class="ui-icon ui-icon-locked"></span>', '#',
							...
							$js->get('#shotcast_change_pass_'.$serverId)->event('click', $event);
		...
		<div style="display: inline;" class="icons">
			<ul id="icons_<?php echo $serverId;?>" class="ui-widget ui-helper-clearfix">
				<li class="ui-state-default ui-corner-all" title="Запустить сервер">
							...
							$effect = $js->get('#server_control_start_'.$serverId)->effect('slideIn');		
							$event  = $js->request(array('controller'=>'servers',
...
?>
		...
		<div id="server_control_start_<?php echo $serverId;?>" style="display:none" title="Управление сервером #<?php echo $serverId;?>: Запуск"><?php echo $html->image("loading.gif");?></div>
