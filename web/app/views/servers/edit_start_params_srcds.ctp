	...
	<tr>					
		<td align="center" colspan="2">
			...
			<div id="action_positive"  style="height: 75px;">
				...
				<?php 
					echo $form->create('Server', array('action' => 'setMapGroup')); 
					echo $form->input('id', array('type'=>'hidden'));
					echo $form->input('action', array('type'=>'hidden', 'value'=>'set'));
				?>
				<div class="control-group">
				    <div class="controls">
				      <div class="input-append input-prepend">
				        <span class="add-on"><i class="icon-list"></i></span><?php 
							...
							echo $form->input('mapGroup', array(
													'options' => @$mapGroups, 
		...
		<div id="action_positive"  style="height: 75px;">
			<h3>Установить режим игры:</h3>
				<?php 
					echo $form->create('Server', array('action' => 'setGameMode')); 
					echo $form->input('id', array('type'=>'hidden'));
					echo $form->input('action', array('type'=>'hidden', 'value'=>'set'));
				?>
				<div class="control-group">
				    <div class="controls">
				      <div class="input-append input-prepend">
				        <span class="add-on"><i class="icon-screenshot"></i></span><?php 
							...
							echo $form->input('gameMode', array(
	...
	<tr>
		...
		<td align="center" colspan="2">
			<div id="action_positive" style="height: 75px;">
				...
				echo $form->create('Server', array('action' => 'setHostMap'));
				?>
		...
		<td align="center" colspan="2">
			<div id="action_positive" style="height: 75px;">
			<?php
				echo $form->create('Server', array('action' => 'setHostCollection'));
			?>
				<table border="0" cellpadding="0" cellspacing="0" align="center">
					<tr>
						...
						<td align="right">
							...
							<div class="control-group">
							    <div class="controls">
									...
									echo $form->input('hostCollectionList',array ( 
									...
									echo $form->input('hostcollection',array ( 
																	'id'    => 'hostCollection',
...
?>
	...
	<div id="action_positive"  style="height: 75px;">	
			...
			<table border="0" cellpadding="0" cellspacing="0" align="center">
				...
				?>
					...
					echo $form->input('rconPassword',array ( 'value' => @$rconPassword, 
															'id'=>'setRconPass',
															'div' => false, 
															'label' => false,
															'style' => 'font-weight: bold; color: #444; text-align: center;'));					
	...
	<tr>	
		...
		<?php echo $form->create('Server',array('action'=>'setFps'));  ?>
		<table border="0" cellpadding="0" cellspacing="0" align="center">
				<tr>
		...
		echo $form->create('Server', array('action' => 'switchUpdate'));	
		echo $form->input('id', array('type'=>'hidden'));					
		echo $js->submit('Отключить',
			array(
				'url'=> array(
	...
	?>
			...
			<?php 
					echo $form->create('Server',array('action'=>'setTickrate'));
					echo $form->input('id', array('type'=>'hidden'));
					echo $form->input('action', array('type'=>'hidden', 'value'=>'set'));
					?>
				<div class="control-group">
				      ...
				      <div class="input-append">
				        <?php 
				        	...
				        	if (empty($this->data['Server']['tickrate']))
				        	{
								...
								if ($this->data['GameTemplate'][0]['name'] == 'csgo-t128')
								{
							...
							if (in_array($this->data['GameTemplate'][0]['name'], array('csgo-t128')))
							{
							...
							echo $form->input('tickrate', array(
...
<?php /* Смена игры сервера (начало) */?>
		...
		<div id="action_positive"  style="height: 75px;">
			...
			echo $html->link($serviceDesc.'Установить', '#',
