		...
		<div style="display: inline;" class="icons">
			<ul id="icons_<?php echo $serverId;?>" class="ui-widget ui-helper-clearfix">
				<li class="ui-state-default ui-corner-all" title="Остановить сервер">
							...
							echo $html->link('<span class="ui-icon ui-icon-stop"></span>', '#',
				...
				<li class="ui-state-default ui-corner-all" title="Перезапустить сервер">
							...
							echo $html->link('<span class="ui-icon ui-icon-refresh"></span>', '#',
				...
				<li class="ui-state-default ui-corner-all" title="Обновить сервер">
							...
							echo $html->link('<span class="ui-icon ui-icon-circle-arrow-n"></span>', '#',
				...
				<li class="ui-state-default ui-corner-all" title="RCON консоль">
							...
							echo $html->link('<span class="ui-icon ui-icon-script"></span>', '#',
				...
				<li class="ui-state-default ui-corner-all" title="Просмотр Лога">
							...
							echo $html->link('<span class="ui-icon ui-icon-note"></span>', '#',
		...
		<div style="display: inline;" class="icons">
			<ul id="icons_<?php echo $serverId;?>" class="ui-widget ui-helper-clearfix">
				<li class="ui-state-default ui-corner-all" title="Запустить сервер">
							...
							echo $html->link('<span class="ui-icon ui-icon-play"></span>', '#',
												array ('id'=>'server_start_stop_'.$serverId, 'escape' => false
												,'onClick'=>""
				...
				<li class="ui-state-default ui-corner-all" title="Принудительно запустить сервер (в случае ошибок запуска)">
							...
							echo $html->link('<span class="ui-icon ui-icon-eject"></span>', '#',
				...
				<li class="ui-state-default ui-corner-all" title="Запустить сервер в режиме отладки">
							...
							echo $html->link('<span class="ui-icon ui-icon-circle-triangle-e"></span>', '#',
		...
		<div style="display: inline;" class="icons">
			<ul id="icons_<?php echo $serverId;?>" class="ui-widget ui-helper-clearfix">
				<li class="ui-state-default ui-corner-all" title="Остановить сервер">
							...
							$js->get('#hltv_start_stop_'.$serverId)->event('click', $event);
				...
				<li class="ui-state-default ui-corner-all" title="Перезапустить сервер">
							...
							$js->get('#hltv_restart_'.$serverId)->event('click', $event);
				...
				<li class="ui-state-default ui-corner-all" title="RCON консоль">
							...
							$js->get('#rcon_hltv_'.$serverId)->event('click', $event);
		...
		<div style="display: inline;" class="icons">
			<ul id="icons_<?php echo $serverId;?>" class="ui-widget ui-helper-clearfix">
				...
				<li class="ui-state-default ui-corner-all" title="Принудительно запустить сервер (в случае ошибок запуска)">
							...
							$js->get('#force_hltv_start_stop_'.$serverId)->event('click', $event);
				...
				switch ( $status['hltvStatus'] ) {
						case "exec_error":
							...
							echo "Ошибка запуска. <br/>" .
								 ...
								 "Если не поможет - обратитесь в техподдержку.";
						    echo "<br/> <small>Время статуса: ".$time->nice($status['hltvStatusTime'])."</small>";
						    echo "</div>";
							break;
						
						case "exec_success":
							if ($time->wasWithinLast('5 minutes', $status['hltvStatusTime'])){
								echo '<div class="ui-state-highlight ui-helper-clearfix ui-corner-all" style="padding: 8px; margin: 5px;">'."\n";
								echo '<span class="ui-icon ui-icon-info" style="float: left; margin-right: .3em;"></span>'."\n";
						...
						case "stopped":
							echo '<div class="ui-state-highlight ui-helper-clearfix ui-corner-all" style="padding: 8px; margin: 5px;">'."\n";
							echo '<span class="ui-icon ui-icon-info" style="float: left; margin-right: .3em;"></span>'."\n";
							echo "Сервер HLTV выключен в ".$time->nice($status['hltvStatusTime']);
							echo "</div>";
							break;
...
<?php
			echo $html->link('Обновить статус', '#',
			...
			$js->get('#server_refresh_'.$serverId)->event('click', $event);
