...
echo "<!-- status start -->";
echo $form->create(null, array( 'url' => 'http://www.teamserver.ru/showServersList',
											'type' => 'GET'));
?>
<table>
	<tr>
		...
		<?php
			...
			echo $form->input('game', array(   'options' => @$gameTemplatesList,
											   'selected' => @$gameTemplateCurrent,
											   'onchange' => 'this.form.submit();',
											   'div' => false,
											   'label' => false));
			echo $form->input('size', array( 'type' => 'hidden',
											   'value' => 'all'));
											   
			echo $form->input('output', array( 'type' => 'hidden',
											   'value' => 'html'));
...
<?php 
	...
	?>
		<tr valign="top">
			<td><?php echo $html->image('https://panel.teamserver.ru/img/icons/servers/'.$server['gameshort'].'.png', 
			...
			<td>
				...
				?>
					<a id="<?php echo 'map_desc_'.$server['mapImage']['id']; ?>" style="display: none;" href="#" class="qlabs_tooltip_diagonal_left qlabs_tooltip_style_1">
						...
						<?php
							echo $html->image('http://www.teamserver.ru/images/gameMaps/'.$server['mapImage']['id'].'.jpg', 
						...
						<?php
						echo $html->image( 'http://www.teamserver.ru/images/gameMaps/'.$server['mapImage']['id'].'_thumb.jpg', 
											array(  'alt'  => @$server['mapImage']['name'],
													'width'  => 100,
													'height' => 75));
						?>
				...
				<?php
					...
					{
						echo $html->image('https://panel.teamserver.ru/img/personage01_x100x75.png', array('title'  => 'Нет изображения карты',
																		   'width'  => 100,
																		   'height' => 75));
					}
				?>
