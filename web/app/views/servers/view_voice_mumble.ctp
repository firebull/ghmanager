...
?>
	...
	<tr>
		...
		<div class="btn-group">
			...
			echo $html->link('<i class="icon-stop"></i>', '#',
			...
			echo $html->link('<i class="icon-refresh"></i>', '#',
			...
			echo $html->link('<i class="icon-lock"></i>', '#',
			...
			$eventChangeRootPass  = $js->request(array('controller'=>'servers',
...
?>
	<tr>
		...
		<div class="btn-group">
			...
			echo $html->link('<i class="icon-play"></i>', '#',
								array ( 'id'=>'server_start_stop_'.$serverId,
										'escape' => false,
