...
<div id="server_params">
	...
	<?php echo $form->create('Server', array('action' => 'editStartParamsEac',
											 'class' => 'form-inline')); ?>
			...
			<tr>
				...
				<td>
					...
					<?php
						...
						echo $form->input('ownServer', array(
			...
			<tr>
				...
				<td>
					...
					<?php
						...
						if (@$eacServer['GameTemplate'][0]['id'] == 38)
						{
							$eacText = 'Вы можете подключить <i>любой</i> сервер с <i>любого</i> хостинга.';
						}

						echo $form->input('connectedAddress', array ( 
														'id'    => 'connectedAddress',
					...
					?>
					<?php
						echo $form->input('rconPass', array ( 
														'id'    => 'rconPass',
														'value' => @$rconPassword,
														'div'   => false, 
														'label' => false,
	...
	<div id="action_positive"  style="height: 120px;">
		...
		<div class="controls" style="margin-top: 15px;">
			<?php
				...
				echo $js->submit('Сохранить и включить EAC',
					array(
						'url'=> array(
										'controller'=>'Servers',
