...
echo $form->create(null, array('url' => '/users/register', 'class' => 'form-horizontal'));
?>
...
<div class="modal-body">
	    ...
	    <div class="controls">
	      <div class="input-prepend">
	        <span class="add-on"><i class="icon-lock"></i></span><?php 
	        	echo $form->input('User.passwd', array('div' => false, 'id' => 'passwd_1', 'type'=>'password', 'label' => false )); ?>
	      </div>
	...
	<div class="control-group" id="passwd2-group">
	    ...
	    <div class="controls">
	      <div class="input-prepend">
	        <span class="add-on"><i class="icon-lock"></i></span><?php 
	        	echo $form->input('User.confirmpassword', array('div' => false, 'id' => 'passwd_2', 'type'=>'password', 'label' => false )); ?>
	      </div>
...
<div class="modal-footer">
	...
	//		echo $form->submit('Регистрация', array ('id' => 'progressSubmit'));
