...
<div class="services form">
	...
	<table border="0" cellpadding="0" cellspacing="3" width="95%">	
		<tr>
			...
			<td align="left">
			<?php echo $form->input('PromoWithCode.type',array (
												  'options' => $types,
												  'selected' => 'code',
												  'id' => 'typesPromo',			
												  'div' => false, 
		...
		<tr>
			...
			<td align="left">
			<?php echo $form->input('PromoCode.0.code',array (
												  'div' => false, 
												  'id' => 'simpleCode',
												  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td align="left">
			<?php echo $form->input('number',array (
												  'div' => false, 
												  'disabled'=>'disabled',
												  'id' => 'numberPromo',
												  'label' => false));?></td>
		...
		<tr>
			...
			<td align="left">
			<?php echo $form->input('PromoWithCode.description',array (
												  'type' => 'textfield',
												  'div' => false, 
												  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td align="left">
			<?php echo $form->input('PromoWithCode.discount',array (
												  'div' => false, 
												  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td align="left">
			<?php echo $form->input('PromoWithCode.valid_through',array (
												  'type' => 'text',
												  'id' => 'validTrough',
