...
<div class="form">
	...
	<table border="0" cellpadding="0" cellspacing="3" width="95%">	
		<tr>
			...
			<?php echo $form->input('Gift.common',array (
														  'div' => false, 
														  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td class="param_value">
			<?php echo $form->input('Gift.slots',array (
														  'div' => false, 
														  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td class="param_value">
			<?php echo $form->input('Gift.week',array (
														  'div' => false, 
														  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td class="param_value">
			<?php echo $form->input('Gift.past',array (
														  'div' => false, 
														  'label' => false));?></td>
		</tr>
		<tr>
			...
			<td class="param_value">
			<?php echo $form->checkbox('Gift.confirm',array (
			 											  'value' => '1',
														  'div' => false, 
														  'label' => false));?></td>
		</tr>
		<tr>
			<td></td>
			<td align="left">
			<?php echo $js->submit('Вперёд!', array (   'id'      => 'gift_submit', 
													    'onClick' => 'ConfirmGift();',
													    'class'   => 'button',
