...
<table class="new_order">
				...
				<tr>
					...
					<div class="accent_lower">
					<?php 
					echo $form->input('slotsDisabled', array('div' => false, 
														'label' => false, 
														'type' => 'hidden',
														'size'=>'2', 
					...
					echo $form->input('slotCost', array('div' => false, 
														'label' => false,
														'type' => 'hidden',
														'size'=>'4',
														'id' => 'slotPrice', 
				...
				<tr>
					...
					<?php 
					echo $form->input('discountDisabled', array('div' => false, 
														'label' => false, 
					...
					<?php 
						...
						if (!empty($this->data['Service'])){
							 ...
							 foreach ( $this->data['Service'] as $service ) {
							 	...
							 	echo $html->div('checkmark_circle_checked qlabs_tooltip_right qlabs_tooltip_style_1', '<span>'.$service['description'].'</span>'.$service['longname'].' - '.$service['price'].' руб./мес.');
		...
		<table class="new_order">
				...
				<tr>
					...
					<?php
						...
						echo $js->submit('Продлить аренду',
													array(
														'url'=> array(
																		'controller'=>'Orders',
