...
<table class="new_order">
				<tr>
					<td class="param_value" colspan="2" style="padding-left: 23px;">
						...
						<?php echo $form->input('Location.id',array ('options'=>$locationsList,
															  'selected'=>$locationId,
															  'id'=>'locations',
															  'div' => false,
															  'label' => false));?>
				...
				<tr>
					...
					<td class="param_value"><?php echo $form->input('Mod.id',
					...
					<td class="param_value" colspan="2" style="padding-left: 23px;">
			            ...
			            <div class="controls">
							...
							echo $form->input('slots', array('div' => false,
																...
																'type'=>'hidden'));?>
							<?php
							echo $form->input('GameTemplate.0.price', array('div' => false,
																'label' => false,
																'id'=>'price',
																'type'=>'hidden'));?>
							<div class="accent">
				...
				<tr>
					...
					<div class="controls">
						...
						<?php
						echo $form->input('discount', array('div' => false,
															'label' => false,
				...
				<tr>
					<td class="param_value" colspan="2">
						<div class="well" style=" margin-bottom: 5px; min-height: 50px;">
							...
							<div id="services" style=""><?php echo $html->image('loading.gif');?> Загрузка списка доступных услуг...</div>
						</div>
					</td>
				</tr>
				<tr>
					<td class="param_value" colspan="2" style="padding-left: 23px;">
			            ...
			            <div class="controls">
							...
							echo $form->input('PromoCode.code', array('div' => false,
																'label' => false,
																'id' => 'promoCode'));

							echo $html->link( 'Проверить код',
											  '#',
											  array(
											  			'id' => 'checkCode',
											  			'class' => 'btn'
						...
						<?php
							echo $form->input('Promo.discount', array('div' => false,
																'label' => false,
																'id' => 'promoDiscount',
																'type'=>'hidden',
																'value' => '0'));
				...
				<tr>
					...
					<?php
					echo $form->input('serviceSum', array('div' => false,
														'label' => false,
														'id' => 'ServiceSum',
														'type'=>'hidden',
														'value'=>'0'));?>
...
<script type="text/javascript">
					...
					$(function() {
						...
						function GetServices () {
						  $("#services").html('<?php echo $html->image('loading.gif');?> Загрузка списка доступных услуг...');
