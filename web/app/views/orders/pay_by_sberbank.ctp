...
<table align="center" width="650" border="0">
  <tr>
    <td><div id="flash"><?php echo $session->flash(); ?></div></td>
  </tr>
</table>
  ...
  <tbody>
	...
	<tbody><tr>
	  <td height="30">
		...
		<td>
			<?php
				echo $html->image('icons/sberbank_114x23.png', array('title' => 'Логотип Сбербанка'))
			?>
		</td>
	  ...
	  <td>
		...
		<td class="h8b" valign="bottom" width="100%">
			<?php 
				...
				' от '.$time->format(@$payParams['orderDate']).
