...
<div class="news">
	...
	<tr>
		...
		<td valign="bottom" align="right">
			<?php 
				echo $html->link('Скрыть', '#', array ('id' => 'close_news', 'title' => 'Скрыть блок новостей'));
				$js->get('#close_news')->event('click', 'newsHide();');
			?>
		</td>
	</tr>
	</table>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		<td valign="bottom" align="right">
			<?php 
				echo $html->link('Скрыть', '#', array ('id' => 'close_news_bottom', 'title' => 'Скрыть блок новостей'));
				$js->get('#close_news_bottom')->event('click', 'newsHide();');
			?>
		</td>
	</tr>
	</table>
