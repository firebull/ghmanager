...
<?php echo $form->create('GameTemplate', array('action' => 'linkConfigAndTagToPlugin')); ?>
	...
	<tr>
			<td colspan="2" align="center"><?php 
					echo $form->input('Plugin.id', array('type'=>'hidden'));
