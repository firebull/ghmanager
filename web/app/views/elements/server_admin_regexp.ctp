...
?>
<?php echo $form->create('Server',array('action'=>'setModAdmin'));  ?>
	...
	<tr>
		...
		<td style="width: 5%;">
			<?php
				...
				$effect = $js->get('#help_mod_amin')->effect('slideIn');		
				...
				$js->get('#help_mod_amin')->event('click', $event);
		...
		<div class="control-group">
		    <div class="controls">
		        <div class="input-append input-prepend">
					...
					echo $form->input('admString',array ( 
													'id'=>'admString',
													'div' => false, 
													'label' => false,
													//'size' => 25,
