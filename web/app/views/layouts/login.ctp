...
<body style="margin-top: 5%;">
	<div class="container">
		<div class="row-fluid show-grid">
			<div class="span3">&nbsp;</div>
			<div class="span6">&nbsp;<?php echo $session->flash(); ?></div>
		</div>
		<div class="row-fluid show-grid">
			<div class="span12">
				&nbsp;
				<div class="row-fluid ">
			    	...
			    	<div class="span4 offset4 pull-left">
			    		<?php echo $html->image('ghmanager_272x42.png', array( 'width' => 272,
			    																'height' => 42,
			    																'class' => 'pull-left',
				    		...
				    		<div class="row-fluid">
				    			...
				    			<div class="span10">
									...
									<div class="input-prepend">
						                ...
						                <span class="add-on"><i class="icon-user"></i></span><?php   echo $form->input('DarkAuth.username', array(	'div' => false,
																							'label' => false,
						            ...
						            <div class="input-prepend">
						                ...
						                <span class="add-on"><i class="icon-lock"></i></span><?php   echo $form->password('DarkAuth.password', array(	'div' => false,
																							'label' => false,
																							'style' => 'width: 205px; margin-bottom: 0px;'
																							));     ?>
			    		...
			    		<div class="span4 border-grey round-border bg-white" style="padding-bottom: 5px;">
			    			...
			    			<div class="row-fluid" style="margin-bottom: 10px;">
			    				...
			    				<div class="span3" style="width: 22.5%">
			    					<center>
			    					<?php    echo $html->image('icons/browser-chrome.png',
					    		...
					    		<div class="span3" style="width: 22.5%">
					    			<center>
					    				<?php    echo $html->image('icons/browser-firefox.png',
								...
								<div class="span3" style="width: 22.5%">
									<center>
										<?php    echo $html->image('icons/browser-opera.png',
								...
								<div class="span3" style="width: 22.5%">
									<center>
										<?php    echo $html->image('icons/browser-safari.png',
