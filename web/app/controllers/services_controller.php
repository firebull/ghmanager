...
class ServicesController extends AppController {
	...
	public $helpers = array('Time', 'Javascript', 'Html', 'Js', 'Cache');
	...
	function getServices ($templateId = null, $rootServer = 'all', $locationId = '2'){
		$this->layout = 'ajax';
	...
	function checkService( $serviceId = null, $templateId = null, $rootServerId = null, $locationId = 'all' ){
	...
	function checkServiceNoPort($rootServerId = null, $templateId = null){
		$this->DarkAuth->requiresAuth();
	...
	// Функция для проверки доступности услуги
	// Красивый порт для запрашиваемого физ. сервера
	function checkServiceDedicatedIp($rootServerId = null, $templateId = null){
		$this->DarkAuth->requiresAuth();
		$this->loadModel('RootServer');
		$this->RootServer->bindModel(array(
					'hasAndBelongsToMany' => array(
