...
class PromosController extends AppController {
	...
	function add() {
		...
		if ($this->data){
			...
			if (!empty($promo['Promo']['number'])) // кол-то кодов, которое надо сгенерировать
			{
	...
	function gift(){
		...
		{
			$this->data['Gift']['common'] = 2;
			$this->data['Gift']['slots']  = 1;
			$this->data['Gift']['week']   = 1;
			$this->data['Gift']['past']   = 1;
		}
