 ...
 */
 ...
 include('loading_params.php');
  ...
  echo $this->Form->create('GameTemplate', array('action' => 'editMap', 'type' => 'file'));
...
<table border="0" cellpadding="0" cellspacing="3" width="95%">
	...
	<tr>
		...
		<td align="left"><?php echo $this->Form->input('Map.GameTemplate',
	...
	<tr>
		...
		if ($this->data['Map']['official'] == 1){
			echo $this->Form->input( 'Map.official',
								array(	'type'=> 'checkbox',
										'value' => 1,
										'checked' => true,
										'div' => false,
	...
	<tr>
		...
		<tr>
			<td colspan="2" align="center"><?php
					...
					echo $this->Form->input(  'Map.id', array(
										'div' => false,
										'label' => false));
