 ...
 */
 ...
 include('loading_params.php');
  ...
  echo $this->Form->create('GameTemplate', array('action' => 'addConfig'));
...
<table border="0" cellpadding="0" cellspacing="3" width="95%">
	<tr>
		...
		<td align="left"><?php echo $this->Form->input('Config.name',
									array(	'size'=> '30',
											'div' => false,
											'label' => false));?>
		</td>
	...
	<tr>
		...
		<td align="left"><?php echo $this->Form->input('Config.path',
									array(	'size'=> '30',
											'div' => false,
											'label' => false));?>
		</td>
