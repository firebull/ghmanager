 ...
 */
 ...
 include('loading_params.php');
  ...
  echo $this->Form->create('GameTemplate', array('action' => 'addType'));
...
<table border="0" cellpadding="0" cellspacing="3" width="95%">
	<tr>
		...
		<td align="left"><?php echo $this->Form->input('Type.name',
									array(	'size'=> '30',
											'div' => false,
											'label' => false));?>
		</td>
		...
		<td align="left"><?php echo $this->Form->input('Type.longname',
									array(	'size'=> '30',
											'div' => false,
											'label' => false));?>
		</td>
