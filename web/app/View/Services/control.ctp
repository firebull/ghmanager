...
<div id="add_service_about">
	...
	echo $this->Html->link('+ Добавить новую услугу', '#',
	...
	$effect = $this->Js->get('#add_service')->effect('slideIn');
	$event  = $this->Js->request(array('controller'=>'Services',
								 'action'=>'add'),
						   array('update' => '#add_service',
								 'before'=>$effect.$loadingShow,
								 'complete'=>$loadingHide));

	$this->Js->get('#service_add_new')->event('click', $event);
...
<div class="services list">
	...
	<tr>
	    ...
	    <div class="icons">
			...
			$effect = $this->Js->get('#edit_service')->effect('slideIn');
			$event  = $this->Js->request(array('controller'=>'Services',
										 'action'=>'edit', $id),
			...
			$this->Js->get('#service_edit_'.$id)->event('click', $event);
			?>
			</li>
