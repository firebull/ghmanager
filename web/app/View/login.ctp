...
<div id="login_form">
		...
		<?php   echo $this->Form->input('DarkAuth.username', array('div' => false, 'label' => false, 'class' => 'loginform' ));     ?>
		</div>
		<div id="loginform_fieldname">
			<label for="username">
		...
		<div id="loginform_input">
			<?php   echo $this->Form->password('DarkAuth.password', array('div' => false, 'label' => false, 'class' => 'loginform_passwd' ));  ?>
			<?php   echo "\n";      ?>
		</div>
		<div id="loginform_fieldname">
			<label for="password">
