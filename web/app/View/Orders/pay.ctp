...
<div id="payment" style="margin-top: 10px;">
	...
	<div id="tabs-1">
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon"></div>
	...
	<div id="tabs-2">
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div class="yandex_money_small"></div>
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div class="rw-h-logo-float-left"></div>
			<div style="float: left; width: 275px; padding-left: 5px;">Комиссия 0%, мгновенное поступление средств</div>',
			'#',
		...
		<div class="zone-white">
			...
			echo $this->Html->link ('<div class="webmoney_small"></div>
		...
		<div class="zone-white">
			...
			echo $this->Html->link ('<div class="qiwi_mid"></div>
			<div style="float: left; width: 245px; padding-left: 5px;">Комиссия 0%, мгновенное поступление средств</div>',
			'#',
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div class="rw-icon rw-icon-emoney"></div>
	...
	<div id="tabs-3">
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon rw-icon-5"></div>
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div class="rw-icon rw-icon-atm"></div>
	...
	<div id="tabs-4">
		<div class="zone-white">
			...
			<?php
			 	echo $this->Form->create('Order', array('action' => 'payBySberbank', 'target'=>'_blank'));
			?>
			<p><span class="ui-icon ui-icon-info" style="float: left; margin-right: .3em;"></span>
				...
				<?php
				echo $this->Form->input('fio',array (	  'size' => '30',
												  'id'=>'fio',
												  'div' => true,
												  'style' => 'float: left;',
												  'label' => false));
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div class="rw-icon rw-icon-bank"></div>
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div class="rw-icon rw-icon-ibank"></div>
	...
	<div id="tabs-5">
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon rw-icon-3""></div>
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon rw-icon-4""></div>
	...
	<div id="tabs-6">
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon rw-icon-mts""></div>
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon rw-icon-euroset""></div>
		...
		<div class="zone-white">
			...
			<?php echo $this->Html->link ('<div style="float: left;" class="rw-icon rw-icon-svyaznoy""></div>
...
<?php
 echo $this->Form->create('Server', array('action' => 'index'));
?>
<?php
...
//	echo $this->Js->submit('Оплатить позже',
//								array(
//									'url'=> array(
//													'controller'=>'Servers',
//													'action'=>'index'
