...
?>
			...
			<?php echo $this->Form->create('User', array('action' => 'confirmByCode', 'class' => 'form-inline')); ?>
			<div class="controls">
		        <?php
...
<div class="well" style="float: left;">
	...
	<div class="control-group"  style="float: left; margin-right: 20px;">
	    ...
	    <div class="controls">
	      <?php echo $this->Form->input('first_name', array( 'div' => false,
		                                             'label' => false,
		                                             'class' => 'span3',
		                                             'placeholder' => 'Имя',
		                                             'id' => 'firstName')); ?>
	...
	<div class="control-group" style="float: left;">
	    ...
	    <div class="controls">
	      <?php echo $this->Form->input('second_name', array( 'div' => false,
		                                             'label' => false,
		                                             'class' => 'span3',
		                                             'placeholder' => 'Фамилия',
		                                             'id' => 'secondName')); ?>
	...
	<div class="control-group"  style="float: left; margin-right: 20px;">
	    ...
	    <div class="controls">
	      <?php echo $this->Form->input('steam_id', array( 'type'=> 'text',
	      											 'div' => false,
		                                             'label' => false,
		                                             'class' => 'span3',
	...
	<div class="control-group" style="float: left;">
	    ...
	    <div class="controls">
	      <?php echo $this->Form->input('guid', array( 'div' => false,
		                                             'label' => false,
		                                             'div' => false,
		                                             'class' => 'span3',
		                                             'placeholder' => 'GUID',
	...
	<div class="control-group"  style="float: left;">
	    ...
	    <div class="controls">
	      <?php echo $this->Form->input('phone', array(   'disabled' => 'disabled',
...
<div class="well" style="float: left;">
	<?php echo $this->Form->create('User', array('action' => 'changePass', 'class' => 'form-inline')); ?>

	<div class="control-group"  style="float: left; margin-right: 20px;">
	    <label class="control-label" for="progressBar">Новый пароль:</label>
	    <div class="controls">
	      <?php echo $this->Form->input('User.newpasswd',array(
														   'type'=>'password',
														   'id' => 'progressBar',
