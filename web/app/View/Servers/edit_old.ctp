...
<cake:nocache>
			...
			<?php echo $this->Form->create('Server', array('action' => 'edit')); ?>
			...
			<table border="0" cellpadding="0" cellspacing="3" width="95%">
				...
				<tr>
					...
					<td align="left"><?php echo $this->Form->input('payedTill', array('type'=>'text','size' => '20', 'div' => false, 'label' => false, 'id'=>'datepicker'));?></td>
				</tr>
<?php /* ?>
				<tr>
					<td align="right">Инициализирован:</td>
					<td align="left"><?php echo $this->Form->checkbox('initialised', array('div' => false, 'label' => false));?></td>
				</tr>
<?php */ ?>
				<tr>
...
//									'buffer' => false));
//
//							$this->Js->get('#submit')->event('click', '$("#edit_server").dialog("destroy");');
