...
<div id="radio_params">
	...
	<?php echo $this->Form->create('Server', array('action' => 'RadioShoutcastParam')); ?>

	<table border="0" cellpadding="2" cellspacing="5">
	<tr>
		<td>RealTime</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.RealTime',
									array(
										'options'=>array(
														'1' => 'Да',
														'0'=> 'Нет'
	...
	<tr>
		<td>ShowLastSongs</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.ShowLastSongs',
									array(
										'size' => '10',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>W3CEnable</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.W3CEnable',
									array(
										'options'=>array(
														'Yes' => 'Да',
														'No'=> 'Нет'
	...
	<tr>
		<td>NameLookups</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.NameLookups',
									array(
										'options'=>array(
														'1' => 'Да',
														'0'=> 'Нет'
	...
	<tr>
		<td>RelayPort</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.RelayPort',
									array(
										'options'=>array(
														'1' => 'Да',
														'0'=> 'Нет'
	...
	<tr>
		<td>RelayServer</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.RelayServer',
									array(
										'size' => '20',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>AutoDumpUsers</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.AutoDumpUsers',
									array(
										'options'=>array(
														'1' => 'Да',
														'0'=> 'Нет'
	...
	<tr>
		...
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.AutoDumpSourceTime',
									array(
										'size' => '10',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>ContentDir</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.ContentDir',
									array(
										'size' => '10',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>IntroFile</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.IntroFile',
									array(
										'size' => '20',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>BackupFile</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.BackupFile',
									array(
										'size' => '20',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>TitleFormat</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.TitleFormat',
									array(
										'size' => '20',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>PublicServer</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.PublicServer',
									array(
										'options'=>array(
														'always'  => 'Всегда',
														'never'   => 'Никогда',
	...
	<tr>
		<td>AllowRelay</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.AllowRelay',
									array(
										'options'=>array(
														'Yes' => 'Да',
														'No'=> 'Нет'
	...
	<tr>
		...
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.AllowPublicRelay',
									array(
										'options'=>array(
														'Yes' => 'Да',
														'No'=> 'Нет'
	...
	<tr>
		<td>MetaInterval</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.MetaInterval',
									array(
										'size' => '10',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>ListenerTimer</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.ListenerTimer',
									array(
										'size' => '10',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>BanFile</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.BanFile',
									array(
										'size' => '25',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>RipFile</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.RipFile',
									array(
										'size' => '25',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>RIPOnly</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.RIPOnly',
									array(
										'options'=>array(
														'Yes' => 'Да',
														'No'=> 'Нет'
	...
	<tr>
		<td>Sleep</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.Sleep',
									array(
										'size' => '10',
										'div' => true,
										'label' => false,
	...
	<tr>
		<td>CleanXML</td>
		<td><?php echo $this->Form->input('RadioShoutcastParam.0.CleanXML',
									array(
										'options'=>array(
														'Yes' => 'Да',
														'No'=> 'Нет'
