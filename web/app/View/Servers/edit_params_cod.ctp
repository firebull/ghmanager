...
echo $this->Html -> link( "<span class=a-menu-btn-text><strong>Серверные конфиги: </strong>".
...
$this->Js->get('#configs_server')->event('click', $event);
...
<?php if (!empty($server['Mod'])) {
			foreach ( $server['Mod'] as $mod ) {
				...
				if (!empty($mod['Config'])) {
                    ...
                    <div style="position: relative;">
                    <?php
                    echo $this->Html -> link( "<span class=a-menu-btn-text><strong>".$mod['longname'].": </strong>".
                    ...
                    $this->Js->get('#configs_mod_'.$mod['id'])->event('click', $event);
...
<?php if (!empty($mods)) {
            foreach ( $mods as $userMod ) {
                if (!empty($userMod)) {
                    ...
                    <div style="position: relative;">
                    <?php
                    echo $this->Html -> link( "<span class=a-menu-btn-text><strong>".ucfirst($userMod)."</strong></span>".
                    ...
                    $this->Js->get('#configs_mod_'.$userMod)->event('click', $event);
