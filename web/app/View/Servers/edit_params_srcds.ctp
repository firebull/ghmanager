	...
	<div class="ui-widget">
		...
		<?php
			       			echo $this->Html->link('Сервера', '#',
										...
										$this->Js->get('#configs_for_server')->event('click', $event);
			...
			foreach ( $server['Mod'] as $mod ) {
				...
				<div class="ui-widget">
					<div class="ui-state-highlight ui-corner-all" style="margin-top: 0px; padding: 0px 4px 3px 3px;">
						...
						?>
				<?php
			       			echo $this->Html->link($mod['longname'], '#',
							...
							$this->Js->get('#configs_for_'.$mod['name'])->event('click', $event);
				...
				if (!empty($plugin['Config'])) {
					...
					<div class="ui-widget">
						<div class="ui-state-highlight ui-corner-all" style="margin-top: 0px; padding: 0px 4px 3px 3px;">
							...
							?>
					<?php
				       			echo $this->Html->link($plugin['longname'], '#',
											...
											$this->Js->get('#configs_for_'.$plugin['name'])->event('click', $event);
