    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            ...
            <div class="accordion-inner">
                ...
                <ul>
                    <li><?php echo $this->Html->link('Webmoney', 'http://www.teamserver.ru/aboutus/howtopay/79-wmhowto',
                                array('target' => '_blank')); ?></li>
                    <li><?php echo $this->Html->link('Яндекс.Деньги', 'http://www.teamserver.ru/aboutus/howtopay/95-yahowto',
                                array('target' => '_blank')); ?></li>
                    <li><?php echo $this->Html->link('Qiwi', 'http://www.teamserver.ru/aboutus/howtopay/135-qiwihowto',
                                array('target' => '_blank')); ?></li>
                    <li><?php echo $this->Html->link('RBK Money, Кредитной картой, Салоны связи и др.', 'http://www.teamserver.ru/aboutus/howtopay/84-rbkhowto',
                                array('target' => '_blank')); ?></li>
                </ul>
            </div>
        </div>
    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            ...
            <div class="accordion-inner">
                ...
                echo $this->Html->link('wiki', 'http://wiki.ghmanager.com/problem-solving:%D1%82%D1%80%D0%B0%D1%81%D1%81%D0%B8%D1%80%D0%BE%D0%B2%D0%BA%D0%B0',
                                array('target' => '_blank'));
    ...
    <div class="accordion-group">
        ...
        <div id="collapse3_2" class="accordion-body collapse">
            <div class="accordion-inner">
                ...
                echo $this->Html->link('инструкция для Sourcemod', 'http://wiki.teamserver.ru/game-mods-tuning:css:installsmplug',
                                array('target' => '_blank'));
    ...
    <div class="accordion-group">
        ...
        <div id="collapse4_2" class="accordion-body collapse">
            <div class="accordion-inner">
                ...
                echo $this->Html->link('инструкция для AmxModx', 'http://wiki.teamserver.ru/server-admin:amxmodx:plugins-install',
                                array('target' => '_blank'));
...
<div id="clear"></div>
<?php
echo $this->Html->tag('button', '<i class="icon-book"></i> Скрыть FAQ', array(  'id' => 'faq_closer',
                                                    'class' => 'btn'));
?>
