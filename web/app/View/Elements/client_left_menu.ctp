...
<ul class="menu_servers_left">
	...
	echo $this->Html->link('Серверы', array (
	...
	echo $this->Html->link('Техническая поддержка', array (
	...
	echo $this->Html->link('Заказы', array (
...
if (strtolower($userinfo['Group'][0]['name'])=='admin'
	...
	echo $this->Html->link('Администрирование', array (
