...
<div class="news">
	...
	<tr>
		<td width="95%"  ><h2 style="margin: 10px 0px 0px 0px;">Новости хостинга</h2></td>
		<td valign="bottom" align="right">
			<?php
				echo $this->Html->link('Скрыть', '#', array ('id' => 'close_news', 'title' => 'Скрыть блок новостей'));
				$this->Js->get('#close_news')->event('click', 'newsHide();');
			?>
		</td>
	</tr>
	</table>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		<td valign="bottom" align="right">
			<?php
				echo $this->Html->link('Скрыть', '#', array ('id' => 'close_news_bottom', 'title' => 'Скрыть блок новостей'));
				$this->Js->get('#close_news_bottom')->event('click', 'newsHide();');
			?>
		</td>
	</tr>
	</table>
